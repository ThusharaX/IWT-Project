...
<div>
  <div class="main">
    <div class="slider">
        ...
        <br>
        <h1 class="main-title" id="mtitle">Reach Our Team </h1>
        <h2 class="sub-title" id="stitle">We love questions and feedback .we're always happy to help!<br>Here are some ways to contact us.</h2>
    </div>
  </div>
  ...
  <div class="groupbox1">
    ...
    <button class="btn" id ="btn1"  type="button" > <img src="./assets/img/phone.png" class="icon" > CALL +9477 46567937 </button> 
  </div>
  ...
  <fieldset class="groupbox2" id="gbox2">
    ...
    <ul type ="none" class ="info">
      <li>
        <span><img src="./assets/img/locate.png" class="icon" ></span>
        <span>No 177, Kandy Road,Malabe,<br>Colombo,Sri Lanka</br></span>
      </li>
      <br>
      <li>
        <span><img src="./assets/img/mail.png" class="icon" ></span> 
        <span>mywedding@company.lk</span><br>
      </li>
      <br><button class="btn" id ="btn1"  type="button" >  <img src="./assets/img/phone.png" class="icon" > CALL +9477 46567937 </button>
    </ul>
  </fieldset>
  ...
  <fieldset class="groupbox3" id="gbox3">
    ...
    <img src= "./assets/img/viber.png" class="icon2" alt="">
    +9477 4656793<br><br>
    <img src ="./assets/img/app.png" class="icon" >+9477 46567937
  </fieldset>
